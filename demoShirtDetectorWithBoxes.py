...
PATH_TO_LABELS = 'Datasets/Models/final_shirt_model/object-detection.pbtxt'
category_index = label_map_util.create_category_index_from_labelmap(PATH_TO_LABELS, use_display_name=True)


# If you want to test the code with your images, just add path to the images to the TEST_IMAGE_PATHS.
PATH_TO_TEST_IMAGES_DIR = pathlib.Path('Datasets/Models/final_shirt_model/images/test/')
...
def show_inference(model, image_path, counter):
  ...
  cv2.imwrite("DemoResult/Detected_and_boxed_" + str(counter) + ".jpg" , image_np)
  return (time_to_run)
